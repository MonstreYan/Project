        ...
        <div class="logoregister-info">
            <div class="logoregister-single">
                ...
                <div class="logoregister-form">
                    ...
                    <form action="findPassword.jsp" method="post" class="login-form" >
                        <label>
                        ...
                        <label>
                            <input type="password" placeholder="请您输入新密码" name="password" class="input-text" required />
                        </label>
                        <label>
                            <input type="password" placeholder="重复输入新密码" name="repassword" class="input-text" required />
                        </label>

                        <label>
                            <input type="submit" class="input-submit1" value="确 认">
                        </label>
                    </form>
                </div>
                <div class="logoregister-black">
          <p><a href="../../index.jsp">返回首页</a> 去<a href="toLogin">登录</a></p>
          <p>使用有问题？<a href="/Home/Linkus/idea.html">意见反馈</a></p><!-- 待改 -->
        </div>
            </div>
        </div>
...
<script>
    jQuery(function(){
        ...
        $('#mobile_verify').bind('click',function(e){
            ...
            //发送信息了 30 s 限制
            get_verify_now("/Home/User/sendMobileVerify.html",$data,30,'mobile_verify');
            return false;
        });
    });
</script>
